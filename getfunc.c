...
{
	spec_t specifiers[] = {
		{"d", print_integer}, {"i", print_integer}, {"c", print_char},
		{"s", str_print}, {"%", prct}, {"u", print_uint},
		{"o", print_uoctal}, {"X", print_upper_hex}, {"x", print_lower_hex},
		{"b", binary_conversion}, {"R", print_rot13}, {"p", print_memory_address},
		{"r", print_reverse}, {"hd", shorty_integer}, {"hi", shorty_integer},
		{"ld", longy_integer}, {"li", longy_integer}, {"S", print_codehex},
